...
To survive, you must use "quantum magic" to access different worlds. By completing gameplay objectives in these worlds (the destructible physics sandbox), you generate training data for your secret pet ML agents, allowing them to perform "proof-of-work" tasks on the AI economy to earn coins.
