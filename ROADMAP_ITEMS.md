...
| 7 | **V22 — the plane the player is in** | week | **next**, and unblocked by step 6. Still owed the fixture-scene rewrite, which is the step that costs both `.rec` recordings |
